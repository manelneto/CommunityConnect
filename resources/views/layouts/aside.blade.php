@section ('aside')
    ...
    <section class="right-bar-popular-questions">
        ...
        <section class="popular-communities">
            ...
            @foreach ($popularCommunities as $community)
                <article class="right-bar-popular">
                    <div class="right-bar-name-and-badge">
                        ...
                        @endif
                        <h4><a href="{{ route('community', ['id' => $community->id]) }}" class="right-bar-name"> {{ $community->name }} </a></h4>
                    </div>
            ...
            @foreach ($popularTags as $tag)
                <article class="right-bar-popular">
                    <div class="right-bar-name-and-badge">
                        ...
                        @endif
                        <h4><a href="/questions?text=%5B{{ str_replace(' ', '%20', $tag->name) }}%5D" class="right-bar-name"> {{ $tag->name }} </a></h4>
                    </div>
