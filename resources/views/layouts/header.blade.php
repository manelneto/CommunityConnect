...
<header class="website-header">
    <div class="header-content">
        <div class="image-and-side-bar-icon">
            <svg class="side-bar-icon" width="25" height="25" viewBox="0 0 60 50" fill="white" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="mid-header">
            ...
            <form action="{{ url('/questions') }}" class="main-search" method="GET">
                <input type="text" name="text" class="live-search" placeholder="{{ request('text', 'Search') }}" value="{{ request('text') }}" autocomplete="off" />
        ...
        <div class="right-header">
            ...
            @auth
            <div class="group-buttons">
                <a href="{{ route('profile', Auth::user()->id) }}" class="my-account-button">My account
                    ({{ Auth::user()->username }})
                </a>
