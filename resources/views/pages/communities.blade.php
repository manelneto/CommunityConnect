            ...
            <section class="add-tooltip">
                ...
                <div class="tooltip-icon">
                    ...
                    <p class="tooltip-text">
                        Here are all the existing Communities listed.
                        Clicking on their name will take you to their page and show you all the questions posted to each one.
                        You can press the <b>Follow</b> button for those questions to appear on your <i>Personal Feed</i>.
                    </p>
                </div>
            </section>
        </header>
