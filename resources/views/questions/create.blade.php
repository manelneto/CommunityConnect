        ...
        <section id="create-question">
            ...
            <article class="add-tooltip" id="add-question-tooltip-section">
                ...
                <div class="tooltip-icon" id="user-edit-profile">
                    ...
                    <p class="tooltip-text">To post a question, write a title describing it in the <b>Title</b> field. Then, choose a community from the <b>Choose a community</b> dropdown menu. Finally, elaborate your question in the <b>Content</b> field. You can also add a file to your question by clicking on the <b>File</b> button and selecting one. When you're done, click on the <b>Submit</b> button.</p>
                </div>
            </article>
            <form action="{{ route('questions') }}" method="post" enctype="multipart/form-data">
                ...
                <section id="property-tags"><h3>Tags</h3></section>
