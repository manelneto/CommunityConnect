        ...
        <div class="main-content">
            <section class="main-info">
                <section class="add-tooltip" id="add-question-tooltip-section">
                    <p class="edit-question-text">Edit Question</p>
                ...
                <form class="question-edit-container" method="post" enctype="multipart/form-data">
                    ...
                    <div class="horizontal-wrapper horizontal-wrapper-edit">
                        ...
                        <div class="edit-question-info">
                            ...
                            <h2 class="question-title"><input id="title" class="question-title-edit" type="text" name="title" value="{{ $question->title }}" placeholder="Enter the question's title here"></h2>
