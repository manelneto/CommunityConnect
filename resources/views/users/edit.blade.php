    ...
    <main>
        <div class="main-content">
            ...
            <form method="post" id="edit-profile" enctype="multipart/form-data">
                ...
                <input class="edit-password" id="current-password" type="password" name="current-password" placeholder="Enter your current password here" class="user-details-input">
                ...
                <input class="edit-password" id="password_confirmation" type="password" name="password_confirmation" placeholder="Retype your new password here" class="user-details-input">
