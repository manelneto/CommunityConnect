    ...
    <main>
        <section class="add-tooltip-edit-profile">
            ...
            <div class="tooltip-icon" id="user-edit-profile">
                ...
                <p class="tooltip-text">You can edit any of your personal details here. To edit your email or username, just click on the field where they appear and change them. To edit your password, click on the <b>Edit Password</b> button and fill in the fields that appear. You can also edit your profile picture by selecting a new one. When you're done, click on the <b>Save</b> button.</p>
            </div>
        </section>
