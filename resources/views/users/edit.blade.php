...
@section('main')
<main>
    <section class="add-tooltip" id="edit-profile-tooltip-section">
        ...
        <div class="tooltip-icon" id="user-edit-profile">
            ...
            <p class="tooltip-text">
                ...
                You can also edit your profile picture by clicking on the <b>Choose File</b> button and selecting a new one.
